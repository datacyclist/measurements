...
file_temperature = open('/var/tmp/temperature_estrich', 'w')	
file_temperature.write(tempshort)
file_temperature.close()

file_humidity = open('/var/tmp/humidity_estrich', 'w')	
file_humidity.write(humishort)
file_humidity.close()
